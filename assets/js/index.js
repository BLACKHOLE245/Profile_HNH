!(function (n) {
            ...
            !(function n() {
                fetch("https://api.thanhdieu.com/rand-music.php")
                    ...
                    .then((t) => {
                        ...
                        FuiToast.promise(h, { loading: "Đang chờ ph\xe1t nhạc...", success: (n) => n.titleTracks, error: "C\xf3 lỗi khi ph\xe1t nhạc!" }, { isClose: !0 }), $("#toast-prompt").slideUp("fast");
                    })
                    .catch((n) => {
    ...
    let o = 0;
    $("body").append(
        `<div id="fui-toast"></div><div class="td-lock-screen"><section class="td-welcome"><div class="medias"><video class="pc item_video" autoplay loop muted playsinline><source src="./assets/video/pc.mp4?v=${c()}" type="video/mp4"></video><video class="mobile item_video" autoplay loop muted playsinline><source src="./assets/video/mb.mp4?v=${c()}" type="video/mp4"></video><div class="date"></div></div><div class="infos"><div class="logo-web-title"><img class="logo-ws" src="https://i.imgur.com/iSFojp8.png" alt="Huỳnh Nhật Huy"><span class="web-title">${
        ...
        MessageRmd() {
            ...
            return (t =
                n >= 3 && n <= 10
                    ...
                    : ["Sao giờ n\xe0y chưa ngủ nữa ୧(๑•̀⌄•́๑)૭", "Khuya rồi, h\xe3y đi ngủ để mơ những giấc mơ thật đẹp nh\xe9 \uD83C\uDF0C", "Đ\xeam muộn thế n\xe0y, đừng qu\xean chăm s\xf3c sức khỏe nha \uD83C\uDF19"])[
            ...
            if (t !== v.text()) {
                ...
                n.css("transform", "translate3d(" + e + "%, 0px, 0px)"),
                    "100%" === t &&
                        ...
                        $("#loading-box").is(":visible") ? (x(), (WsLoaded = !0), $(".td-loading-v2").fadeOut("slow"), $("#loading-box").fadeOut("slow")) : $(".td-loading-v2").fadeOut("slow"),
                        clearInterval(w));
            }
        }
    }, 100);
    ...
    $(window).on("load", () => {
        ...
        console.log("%c My Github %c https://github.com", "color:#fff;background:linear-gradient(90deg,#448bff,#44e9ff);padding:5px 0;", "color:#000;background:linear-gradient(90deg,#44e9ff,#ffffff);padding:5px 10px 5px 0px;");
    var _,
        C,
        T = new Image();
    ...
    function S() {
        ...
        for (var r = new SakuraList(), l = 0; l < 10; l++)
            (t = q("x")), (e = q("y")), (h = q("r")), (i = q("s")), (c = q("fnx")), (o = q("fny")), (randomFnR = q("fnr")), (n = new E(t, e, i, h, { x: c, y: o, r: randomFnR })).draw(a), r.push(n);
    ...
    function A() {
        ...
        (E.prototype.update = function () {
            (this.x = this.fn.x(this.x, this.y)),
                ...
                (this.x > window.innerWidth || this.x < 0 || this.y > window.innerHeight || this.y < 0) &&
                    ((this.r = q("fnr")), Math.random() > 0.4 ? ((this.x = q("x")), (this.y = 0), (this.s = q("s")), (this.r = q("r"))) : ((this.x = window.innerWidth), (this.y = q("y")), (this.s = q("s")), (this.r = q("r"))));
        }),
        ((SakuraList = function () {
            this.list = [];
